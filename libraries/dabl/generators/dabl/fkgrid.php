...
<h1>
	...
	<a href="<?php echo "<?php echo" ?> site_url('<?php echo $plural_url ?>/edit/&<?php echo $foreign_column ?>=' . $<?php echo $fk_single ?>->get<?php echo $foreign_column ?>()) <?php echo "?>" ?>" class="ui-state-default ui-corner-all ui-button-link" title="New <?php echo str_replace('_', ' ', ucfirst($single)) ?>">
