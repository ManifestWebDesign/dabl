...
<h1>
	...
	<a href="<?php echo "<?php echo" ?> site_url('<?php echo $plural_url ?>/edit?<?php echo $local_column ?>=' . $<?php echo $fk_single ?>->get<?php echo StringFormat::titleCase($foreign_column) ?>()) <?php echo "?>" ?>"
